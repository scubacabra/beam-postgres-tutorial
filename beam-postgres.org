...
***** getting the inner join through references, beam automatically generate clause matching primary keys  :ask:error thrown:
...
**** TODO using on clause with related_ to get postgres to work          :ask:lens accessor mixing:
...
**** TODO from a Text value :what does val_ do?:
    We can use ~val_~ to ???
...
**** TODO from a UserId value :what is the difference between this and above:
...
** TODO deletions with delete                                            :ask:compiler error val_:
